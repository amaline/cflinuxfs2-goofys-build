...
#
#   PROGRAM: deploy.sh
#   PURPOSE: Creates a github release and uploads ${ARTIFACT_NAME} binary in gzip tar format to github
#   EXIT CODES:
...
RELEASE="Release ${GITHUB_RELEASE} for ${ARTIFACT_NAME} build for cflinuxfs2"
